<aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="{{ Request::is('admin/favorite*') ? 'active' : '' }}">
                        <a href="{{route('admin.index.favorite')}}">
                    ...
                    <li class="{{ Request::is('admin/comment*') ? 'active' : '' }}">
                        <a href="{{route('admin.index.comment')}}">
                    ...
                    <li class="{{ Request::is('author/post*') ? 'active' : '' }}">
                      ...
                      <li class="{{ Request::is('author/comment*') ? 'active' : '' }}">
                        <a href="{{route('author.index.comment')}}">
                            <i class="material-icons">comment</i>
                            <span>Comments</span>
                        </a>
                    </li>
                     ...
                     <li class="{{ Request::is('author/favorite*') ? 'active' : '' }}">
                        <a href="{{route('author.index.favorite')}}">
                            <i class="material-icons">favorite</i>
                            <span>Favorite</span>
                        </a>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2020 - 2021 <a href="">Dashboard</a>.
                </div>
